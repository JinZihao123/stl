...
template<class ForwardIterator, class ForwardIterator, class Size, class T>
ForwardIterator __uninitialized_fill_n_aux(ForwardIterator first, Size n, const T &x, unknown pod);

template<class ForwardIterator, class InputIterator, class InputIterator, typename T>
ForwardIterator __uninitialized_copy(InputIterator first, InputIterator last, T *type);

template<class ForwardIterator, class InputIterator, class InputIterator>
ForwardIterator __uninitialized_copy_aux(InputIterator first, InputIterator last, __false_type type);

template<class ForwardIteraor, class ForwardIteraor, class ForwardIteraor, class T, class T>
ForwardIteraor __uninitialized_fill(ForwardIteraor first, const T &x, T *type);

template<class ForwardIteraor, class ForwardIteraor, class ForwardIteraor, class T>
ForwardIteraor __uninitialized_fill_aux(ForwardIteraor first, ForwardIteraor last, const T &x, __false_type type);
...
inline ForwardIterator __uninitialized_fill_n_aux(ForwardIterator first, Size n, const T &x, __true_type) {
    return fill_n(first,n,x);//TODO 用的STL算法
};
template<class ForwardIterator, class Size, class T>
...
ForwardIterator __uninitialized_copy_aux(InputIterator first, InputIterator last,ForwardIterator result, __true_type) {
    copy(first,last,result);//TODO 用了stl算法
}
...
inline void __uninitialized_fill_aux(ForwardIteraor first, ForwardIteraor last, const T &x, __true_type ) {
    fill(first,last,x);//TODO 用了stl算法
};
